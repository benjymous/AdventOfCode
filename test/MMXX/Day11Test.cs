...
namespace Advent.MMXX.Test
{
    ...
    public class Day11Test
    {
        ...
        {
            Assert.AreEqual(expected, MMXX.Day11.Part1(input));
        }
        ...
        {
            Assert.AreEqual(expected, MMXX.Day11.TestNeighbours(input, x, y));
        }
        ...
        {
            Assert.AreEqual(expected, MMXX.Day11.Part2(input));
        }
