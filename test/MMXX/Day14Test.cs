...
namespace Advent.MMXX.Test
{
    ...
    public class Day14Test
    {
        ...
        {
            Assert.AreEqual(expected, MMXX.Day14.ApplyMaskV1(value, Day14.Mask(input)));
        }
        ...
        {
            Assert.AreEqual(expected, MMXX.Day14.Part1(input));
        }
        ...
        {
            Assert.AreEqual(expected, MMXX.Day14.Part2(input));
        }
