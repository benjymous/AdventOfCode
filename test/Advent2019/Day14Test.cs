...
namespace AoC.Advent2019.Test
{
    ...
    public class Day14Test
    {
        ...
        [DataTestMethod]
        public void OreReductionTest(string input, Int64 expected)
        {
        ...
        // [DataTestMethod]
        // public void FuelEstimation(string input, Int64 expected)
        // {
        ...
        [DataTestMethod]
        public void Ore_Part1_Regression()
        {
            Assert.AreEqual(870051, Day14.Part1(input));
        }

        [TestCategory("Regression")]
        [DataTestMethod]
        public void Ore_Part2_Regression()
        {
            Assert.AreEqual(1863741, Day14.Part2(input));
        }
    }
}
