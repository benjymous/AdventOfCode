...
fold along x=5";
        ...
        {
            Assert.AreEqual("243C751E061AA9A187EDACEE48B7965C", Day13.Part2(test.Replace("\r", ""), new ConsoleOut()).GetMD5String(false));
        }
        ...
        {
            Assert.AreEqual("EPLGRULR", Utils.OCR.TextReader.Read(Day13.Part2(input, new ConsoleOut())));
        }
    }
}
