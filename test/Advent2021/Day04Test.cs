...
namespace AoC.Advent2021.Test
{
    ...
    public class Day04Test
    {
        ...
        readonly string test = @"7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1
...
22 11 13  6  5
 2  0 12  3  7";
        ...
        {
            Assert.AreEqual(4512, Day04.Part1(test.Replace("\r", "")));
        }
        ...
        {
            Assert.AreEqual(1924, Day04.Part2(test.Replace("\r", "")));
        }
