...
public class Day11Test
{
    ...
    {
        Assert.IsTrue(Day11.Part1(input) == expected);
    }
    ...
    {
        Assert.IsTrue(Day11.Part2(input) == expected);
    }
    ...
    {
        Assert.AreEqual(0, Day11.Part1(input));
    }
    ...
    {
        Assert.AreEqual(0, Day11.Part2(input));
    }
}
