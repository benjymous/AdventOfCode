...
public class Day13Test
{
    ...
    {
        Assert.IsTrue(Day13.Part1(input) == expected);
    }
    ...
    {
        Assert.IsTrue(Day13.Part2(input) == expected);
    }
    ...
    {
        Assert.AreEqual(0, Day13.Part1(input));
    }
    ...
    {
        Assert.AreEqual(0, Day13.Part2(input));
    }
}
