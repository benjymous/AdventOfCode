...
namespace AoC.Advent2023.Test
{
    ...
    public class Day15Test
    {
        ...
        {
            Assert.IsTrue(Day15.Part1(input) == expected);
        }
        ...
        {
            Assert.IsTrue(Day15.Part2(input) == expected);
        }
        ...
        {
            Assert.AreEqual(0, Day15.Part1(input));
        }
        ...
        {
            Assert.AreEqual(0, Day15.Part2(input));
        }
    }
}
