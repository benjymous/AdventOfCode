...
namespace Advent.MMXVI
{
    public class Day03 : IPuzzle
    {
        ...
        {
            // console.WriteLine(TriangleValid(5,5,5));
            // console.WriteLine(TriangleValid(5,10,25));

            // console.WriteLine(TriangleValid(7,10,5));
            // console.WriteLine(TriangleValid(1,10,12));

            //console.WriteLine(Part2("101 301 501\n102 302 502\n103 303 503\n201 401 601\n202 402 602\n203 403 603"));
