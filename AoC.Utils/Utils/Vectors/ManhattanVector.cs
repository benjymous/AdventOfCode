...
{
    public class ManhattanVectorN(int[] components)
    {
        public ManhattanVectorN(string val) : this(Util.ParseNumbers<int>(val)) { }

        public int[] Component = [.. components];

        public int ComponentCount => Component.Length;

        public override string ToString() => string.Join(",", Component);
        ...
        protected void Offset(ManhattanVectorN offset) => Offset(offset.Component);
    ...
    public class ManhattanVector2 : ManhattanVectorN
    {
        ...
        public PackedPos32 AsPackedPos32() => (X, Y);
        ...
        public static ManhattanVector2 operator +(ManhattanVector2 a, ManhattanVector2 b) => new(a + (ManhattanVectorN)b);
    ...
    public class Direction2
    {
        ...
        public static bool operator ==(Direction2 v1, Direction2 v2) => v1.DX == v2.DX && v1.DY == v2.DY;

        public static bool operator !=(Direction2 v1, Direction2 v2) => v1.DX != v2.DX || v1.DY != v2.DY;

        public static Direction2 operator +(Direction2 a, Direction2 b) => new Direction2(b).TurnLeftBySteps(a.RotationSteps());
        ...
        public static Direction2 operator +(Direction2 a, int b) => new Direction2(a).TurnRightBySteps(b);

        public static Direction2 operator -(Direction2 a, int b) => new Direction2(a).TurnLeftBySteps(b);
        ...
        public override bool Equals(object obj) => obj is Direction2 && (obj as Direction2) == this;
    ...
    {
        public static (int minZ, int maxZ, int minY, int maxY, int minX, int maxX) GetRange(this IEnumerable<(int X, int Y, int Z)> input)
        {
        ...
        public static (int minY, int maxY, int minX, int maxX) GetRange(this IEnumerable<(int X, int Y)> input)
        {
        ...
        public static (int minZ, int maxZ, int minY, int maxY, int minX, int maxX) GetRange<T>(this IEnumerable<T> input, Func<T, (int X, int Y, int Z)> selector) => input.Select(selector).GetRange();

        public static (int minZ, int maxZ, int minY, int maxY, int minX, int maxX) GetRange(this IEnumerable<ManhattanVector3> input) => input.Select(v => v.AsSimple()).GetRange();

        public static (int minY, int maxY, int minX, int maxX) GetRange<T>(this IEnumerable<T> input, Func<T, (int X, int Y)> selector) => input.Select(selector).GetRange();

        public static (int minY, int maxY, int minX, int maxX) GetRange(this IEnumerable<ManhattanVector2> input) => input.Select(v => v.AsSimple()).GetRange();
