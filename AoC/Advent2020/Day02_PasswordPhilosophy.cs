...
public class Day02 : IPuzzle
{
    ...
    public static int Part1(Parser.AutoArray<Record> input) => input.Count(r => r.ValidPt1);

    public static int Part2(Parser.AutoArray<Record> input) => input.Count(r => r.ValidPt2);
