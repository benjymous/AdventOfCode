...
public class Day12 : IPuzzle
{
    ...
    public static int Part1(string input)
    {
        ...
        Util.RegexFactory<Action<ManhattanVector2, Direction2>, FactoryPt1>(input).ForEach(i => i(position, direction));
    ...
    public static int Part2(string input)
    {
        ...
        Util.RegexFactory<Action<ManhattanVector2, ManhattanVector2>, FactoryPt2>(input).ForEach(i => i(position, waypoint));
