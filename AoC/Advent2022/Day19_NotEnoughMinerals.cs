...
public class Day19 : IPuzzle
{
    ...
    public static int Part1(Parser.AutoArray<Blueprint> input) => input.AsParallel().Sum(bp => bp.Run(24).score);

    public static long Part2(Parser.AutoArray<Blueprint> input) => input.Take(3).AsParallel().Product(bp => bp.Run(32).geodes);
