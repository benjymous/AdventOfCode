...
namespace AoC.Advent2015
{
    public class Day07 : IPuzzle
    {
        ...
        {
            public Circuit(string input) => index = Util.RegexParse<Component>(input).ToDictionary(c => c.OutName.StringValue);
        ...
        {
            return new Circuit(input).Solve("a");
        }

        public static int Part2(string input)
        {
            return new Circuit(input).Override("b", 16076).Solve("a");
        }
